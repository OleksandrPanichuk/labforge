...
// emits literal <undefined> tags, so the real element has to be taken out of it.
...
function textWidthTwips(context: BlockContext): number {
  ...
  return mmToTwips(A4_WIDTH_MM - margins.left - margins.right);
}
